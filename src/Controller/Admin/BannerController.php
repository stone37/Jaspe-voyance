...
class BannerController extends AbstractController
{
        ...
        EventDispatcherInterface $dispatcher)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('info', 'Une bannière a été crée');
        ...
        EventDispatcherInterface $dispatcher, $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('info', 'Une bannière a été mise à jour');
        ...
        $id)
    {
        ...
        if ($request->getMethod() == 'DELETE') {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash('info', 'La bannière a été supprimé');
            } else {
    ...
    )
    {
        ...
        if ($request->getMethod() == 'DELETE') {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash('info', 'Les bannières ont été supprimé');
            } else {
