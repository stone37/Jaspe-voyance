...
class CommentController extends AbstractController
{
    ...
    {
        $qb = $em->getRepository(Comments::class)->findBy([], ['createdAt' => 'desc']);
    ...
    private function deleteForm(Comments $comments)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('app_admin_comment_delete', ['id' => $comments->getId()]))
            ->setMethod('DELETE')
            ->getForm();
    }
